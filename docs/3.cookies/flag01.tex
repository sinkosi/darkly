...
\begin{figure}[!htb]
    \centering
    \subfloat[Console Screen showing cookie error]{\includegraphics[width=.45\columnwidth]{3.cookies/01-02a.png}\label{fig: 3-2a cookie string}} \quad
    \subfloat[Hash returning 'false']{\includegraphics[width=.45\columnwidth]{3.cookies/01-02b.png}\label{fig: cookie hash is false}} \\
    \subfloat[My own 'true' hash]{\includegraphics[width=.45\columnwidth]{3.cookies/01-02c.png}\label{fig: 01 - My own true hash}} \quad
    \subfloat[Replaced hash \& ready to refresh]{\includegraphics[width=.45\columnwidth]{3.cookies/01-02d.png}\label{fig: 01 - Ready to refresh}}
